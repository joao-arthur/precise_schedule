...
mod test {
    ...
    fn test_event() {
        assert_eq!(
            DtEvt::of(Dt::of(2024, 11, 22), Freq::M6),
    ...
    fn test_closest_rep_none() {
        assert_eq!(
            closest_rep(DtEvt { dt: Dt::of(2000, 01, 01), freq: None }, Dt::of(2023, 08, 01)),
            None
        );
    }
    ...
    fn test_rep_between_1d() {
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2023, 07, 01), Freq::D1),
                Dt::of(2023, 08, 01),
                Dt::of(2023, 08, 31)
            ),
            vec![
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2023, 07, 20), Freq::D1),
                Dt::of(2023, 07, 01),
                Dt::of(2023, 07, 31)
            ),
            vec![
    ...
    fn test_rep_between_2d() {
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2023, 07, 01), Freq::D2),
                Dt::of(2023, 08, 01),
                Dt::of(2023, 08, 31)
            ),
            vec![
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2023, 07, 20), Freq::D2),
                Dt::of(2023, 07, 01),
                Dt::of(2023, 07, 31)
            ),
            vec![
    ...
    fn test_rep_between_1w() {
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2023, 07, 01), Freq::W1),
                Dt::of(2023, 08, 01),
                Dt::of(2023, 08, 31)
            ),
            vec![
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2023, 08, 16), Freq::W1),
                Dt::of(2023, 08, 01),
                Dt::of(2023, 08, 31)
            ),
    ...
    fn test_rep_between_1m() {
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2023, 06, 10), Freq::M1),
                Dt::of(2023, 08, 01),
                Dt::of(2023, 08, 31)
            ),
            [Dt::of(2023, 08, 10)]
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 01, 28), Freq::M1),
                Dt::of(2020, 02, 01),
                Dt::of(2020, 02, 29)
            ),
            [Dt::of(2020, 02, 28)]
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 01, 29), Freq::M1),
                Dt::of(2020, 02, 01),
                Dt::of(2020, 02, 29)
            ),
            [Dt::of(2020, 02, 29)]
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 01, 30), Freq::M1),
                Dt::of(2020, 02, 01),
                Dt::of(2020, 02, 29)
            ),
            [Dt::of(2020, 02, 29)]
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 01, 31), Freq::M1),
                Dt::of(2020, 02, 01),
                Dt::of(2020, 02, 29)
            ),
            [Dt::of(2020, 02, 29)]
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2023, 08, 10), Freq::M1),
                Dt::of(2023, 08, 01),
                Dt::of(2023, 08, 31)
            ),
            [Dt::of(2023, 08, 10)]
    ...
    fn test_rep_between_3m() {
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 01, 28), Freq::M3),
                Dt::of(2020, 03, 01),
                Dt::of(2020, 03, 31)
            ),
            []
        ...
        assert_eq!(
            ...
            vec![Dt::of(2020, 04, 28)]
        );
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 01, 29), Freq::M3),
                Dt::of(2020, 04, 01),
                Dt::of(2020, 04, 30)
            ),
            vec![Dt::of(2020, 04, 29)]
        );
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 01, 30), Freq::M3),
                Dt::of(2020, 04, 01),
                Dt::of(2020, 04, 30)
            ),
            vec![Dt::of(2020, 04, 30)]
        );
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 01, 31), Freq::M3),
                Dt::of(2020, 04, 01),
                Dt::of(2020, 04, 30)
            ),
            vec![Dt::of(2020, 04, 30)]
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 04, 10), Freq::M3),
                Dt::of(2020, 04, 01),
                Dt::of(2020, 04, 30)
            ),
            vec![Dt::of(2020, 04, 10)]
        );
    }
    ...
    fn test_rep_between_6m() {
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 01, 31), Freq::M6),
                Dt::of(2020, 03, 01),
                Dt::of(2020, 03, 31)
            ),
            []
        ...
        assert_eq!(
            ...
            vec![Dt::of(2020, 07, 31)]
        );
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 07, 31), Freq::M6),
                Dt::of(2021, 01, 01),
                Dt::of(2021, 01, 31)
            ),
            vec![Dt::of(2021, 01, 31)]
        );
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2023, 06, 29), Freq::M6),
                Dt::of(2023, 06, 01),
                Dt::of(2023, 06, 30)
            ),
            vec![Dt::of(2023, 06, 29)]
        );
    }
    ...
    fn test_rep_between_1y() {
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2019, 02, 28), Freq::Y1),
                Dt::of(2020, 01, 01),
                Dt::of(2020, 01, 31)
            ),
            []
        ...
        assert_eq!(
            ...
            vec![Dt::of(2025, 02, 28)]
        );
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 02, 29), Freq::Y1),
                Dt::of(2025, 02, 01),
                Dt::of(2025, 02, 28)
            ),
            vec![Dt::of(2025, 02, 28)]
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2021, 02, 28), Freq::Y1),
                Dt::of(2025, 02, 01),
                Dt::of(2025, 02, 28)
            ),
            vec![Dt::of(2025, 02, 28)]
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2022, 02, 28), Freq::Y1),
                Dt::of(2025, 02, 01),
                Dt::of(2025, 02, 28)
            ),
            vec![Dt::of(2025, 02, 28)]
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2021, 11, 11), Freq::Y1),
                Dt::of(2021, 11, 01),
                Dt::of(2021, 11, 30)
            ),
            vec![Dt::of(2021, 11, 11)]
        );
    }
    ...
    fn test_rep_between_2y() {
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 01, 31), Freq::Y2),
                Dt::of(2020, 07, 01),
                Dt::of(2020, 07, 30)
            ),
            []
        ...
        assert_eq!(
            ...
            vec![Dt::of(2022, 01, 31)]
        );
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2020, 07, 15), Freq::Y2),
                Dt::of(2020, 07, 01),
                Dt::of(2021, 07, 31)
            ),
            vec![Dt::of(2020, 07, 15)]
        );
    }
    ...
    fn test_rep_between_none() {
        assert_eq!(
            rep_between(
                DtEvt { dt: Dt::of(2000, 01, 01), freq: None },
                Dt::of(2023, 08, 01),
                Dt::of(2023, 08, 31)
            ),
            vec![]
        ...
        assert_eq!(
            rep_between(
                DtEvt { dt: Dt::of(2023, 08, 22), freq: None },
                Dt::of(2023, 08, 01),
                Dt::of(2023, 08, 31)
            ),
            [Dt::of(2023, 08, 22)]
    ...
    fn test_rep_between_between_repetition() {
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2008, 03, 01), Freq::M3),
                Dt::of(2008, 04, 01),
                Dt::of(2008, 04, 30)
            ),
            []
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2009, 04, 01), Freq::M6),
                Dt::of(2009, 08, 01),
                Dt::of(2009, 08, 31)
            ),
            []
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2010, 05, 01), Freq::Y1),
                Dt::of(2011, 04, 01),
                Dt::of(2011, 04, 30)
            ),
            []
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2011, 06, 01), Freq::Y2),
                Dt::of(2012, 06, 01),
                Dt::of(2012, 06, 30)
            ),
            []
    ...
    fn test_rep_between_before_date() {
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2000, 01, 01), Freq::D1),
                Dt::of(1999, 12, 01),
                Dt::of(1999, 12, 31)
            ),
            []
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2023, 06, 01), Freq::D2),
                Dt::of(2023, 05, 01),
                Dt::of(2023, 05, 31)
            ),
            []
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2021, 04, 01), Freq::M1),
                Dt::of(2021, 03, 01),
                Dt::of(2021, 03, 31)
            ),
            []
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2009, 10, 01), Freq::M6),
                Dt::of(2009, 09, 01),
                Dt::of(2009, 09, 30)
            ),
            []
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2010, 09, 01), Freq::Y1),
                Dt::of(2010, 08, 01),
                Dt::of(2010, 08, 31)
            ),
            []
        ...
        assert_eq!(
            rep_between(
                DtEvt::of(Dt::of(2011, 08, 01), Freq::Y2),
                Dt::of(2011, 07, 01),
                Dt::of(2011, 07, 31)
            ),
            []
