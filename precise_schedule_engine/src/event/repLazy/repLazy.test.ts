...
it("repLazy 1_D", () => {
    const itt = repLazy({ d: "2000-01-01", freq: "1_D" });
...
it("repLazy 1_D", () => {
    const itt = repLazy({ d: "2020-02-27", freq: "1_D" });
...
it("repLazy 1_D", () => {
    const itt = repLazy({ d: "2021-02-27", freq: "1_D" });
...
it("repLazy 2_D", () => {
    const itt = repLazy({ d: "2000-01-01", freq: "2_D" });
...
it("repLazy 2_D", () => {
    const itt = repLazy({ d: "2020-02-27", freq: "2_D" });
...
it("repLazy 2_D", () => {
    const itt = repLazy({ d: "2021-02-27", freq: "2_D" });

    assert.strictEqual(itt.next().value, "2021-03-01");
});

it("repLazy 1_W", () => {
    const itt = repLazy({ d: "2000-01-01", freq: "1_W" });
...
it("repLazy 1_W", () => {
    const itt = repLazy({ d: "2020-02-21", freq: "1_W" });
...
it("repLazy 1_W", () => {
    const itt = repLazy({ d: "2021-02-21", freq: "1_W" });
...
it("repLazy 1_M", () => {
    const itt = repLazy({ d: "2000-01-01", freq: "1_M" });
...
it("repLazy 1_M", () => {
    const itt = repLazy({ d: "2020-01-31", freq: "1_M" });
...
it("repLazy 1_M", () => {
    const itt = repLazy({ d: "2021-01-31", freq: "1_M" });
...
it("repLazy 3_M", () => {
    const itt = repLazy({ d: "2000-01-01", freq: "3_M" });
...
it("repLazy 3_M", () => {
    const itt = repLazy({ d: "2019-11-30", freq: "3_M" });
...
it("repLazy 6_M", () => {
    const itt = repLazy({ d: "2000-01-01", freq: "6_M" });
...
it("repLazy 6_M", () => {
    const itt = repLazy({ d: "2019-08-31", freq: "6_M" });
...
it("repLazy 1_Y", () => {
    const itt = repLazy({ d: "2000-01-01", freq: "1_Y" });
...
it("repLazy 1_Y", () => {
    const itt = repLazy({ d: "2020-02-29", freq: "1_Y" });
...
it("repLazy 2_Y", () => {
    const itt = repLazy({ d: "2000-01-01", freq: "2_Y" });
...
it("repLazy 2_Y", () => {
    const itt = repLazy({ d: "2020-02-29", freq: "2_Y" });
...
it("repLazy NEVER", () => {
    const itt = repLazy({ d: "2000-01-01", freq: "NEVER" });
