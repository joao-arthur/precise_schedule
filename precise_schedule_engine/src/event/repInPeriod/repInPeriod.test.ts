...
it("repInPeriod 3M", () => {
    assert.deepEqual(
        repInPeriod({ d: "2020-01-28", freq: "3M" }, "2020-03-01", "2020-03-31"),
        [],
    );
    assert.deepEqual(
...
it("repInPeriod 6M", () => {
    assert.deepEqual(
        repInPeriod({ d: "2020-01-31", freq: "6M" }, "2020-03-01", "2020-03-31"),
        [],
    );
    assert.deepEqual(
    ...
    assert.deepEqual(
        repInPeriod({ d: "2023-06-29", freq: "6M" }, "2023-06-01", "2020-06-30"),
        [
            // "2023-06-29"
        ],
    );
...
it("repInPeriod 1Y", () => {
    assert.deepEqual(
        repInPeriod({ d: "2019-02-28", freq: "1Y" }, "2020-01-01", "2020-01-31"),
        [],
    );
    assert.deepEqual(
    ...
    assert.deepEqual(
        repInPeriod({ d: "2021-11-11", freq: "1Y" }, "2021-11-01", "2020-11-30"),
        [
            //"2021-11-11",
        ],
    );
...
it("repInPeriod 2Y", () => {
    assert.deepEqual(
        repInPeriod({ d: "2020-01-31", freq: "2Y" }, "2020-07-01", "2020-07-30"),
        [],
    );
    assert.deepEqual(
