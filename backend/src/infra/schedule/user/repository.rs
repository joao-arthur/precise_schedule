...
mod test {
    ...
    use super::UserRepositoryMemory;
        ...
        async fn test_user_repo_memory() {
            ...
            assert_eq!(repository.read_by_credentials(&UserCredentials { username: "macca".into(), password: "asdf!@#123".into() }).await, Ok(None));
            assert_eq!(
                repository.read_count_unique_info(&UserUniqueInfo { email: "paul@gmail.com".into(), username: "macca".into() }).await,
