...
pub fn validation_i18n(v: &V, lg: &Language) -> String {
    ...
    match v {
        ...
        // V::Date => String::from(rust_i18n::t!("validation.date", locale = locale)),
        // V::Time => String::from(rust_i18n::t!("validation.time", locale = locale)),
        // V::Datetime => String::from(rust_i18n::t!("validation.datetime", locale = locale)),
        ...
        // V::Enumerated(v) => String::from(rust_i18n::t!("validation.enum", locale = locale)).replace("{}", &format!("{v}")),
        // V::Eq(v) => String::from(rust_i18n::t!("validation.eq", locale = locale)).replace("{}", &format!("{v}")),
        // V::Ne(v) => String::from(rust_i18n::t!("validation.ne", locale = locale)).replace("{}", &format!("{v}")),
        // V::Ge(v) => String::from(rust_i18n::t!("validation.ge", locale = locale)).replace("{}", &format!("{v}")),
        // V::Gt(v) => String::from(rust_i18n::t!("validation.gt", locale = locale)).replace("{}", &format!("{v}")),
        // V::Le(v) => String::from(rust_i18n::t!("validation.le", locale = locale)).replace("{}", &format!("{v}")),
        // V::Lt(v) => String::from(rust_i18n::t!("validation.lt", locale = locale)).replace("{}", &format!("{v}")),
    }
}
