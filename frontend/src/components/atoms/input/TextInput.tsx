...
function TextInputComp({ forwardedRef, ...props }: props) {
    return (
        <input
            {...props}
            ref={forwardedRef}
...
export const TextInput = forwardRef<HTMLInputElement | null, forwardedProps>(
    (props, ref) => <TextInputComp {...props} forwardedRef={ref} />,
);
